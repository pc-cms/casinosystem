...
BEGIN
  ...
  UPDATE public.players SET status = _status WHERE id = _player_id;

  INSERT INTO public.player_notes (player_id, content, note_type, created_by)
  VALUES (
    _player_id,
  ...
  INSERT INTO public.activity_logs (casino_id, action_type, action_category, details, user_id)
  VALUES (
    v_casino,
...
GRANT EXECUTE ON FUNCTION public.manager_set_player_blacklist(uuid, uuid, text, text) TO authenticated;
