...
const routeLoaders: Loader[] = [
  ...
  () => import("@/pages/Admin"),
  () => import("@/pages/Staff"),
  () => import("@/pages/finance/FinanceWalletsPage"),
  () => import("@/pages/finance/FinanceDashboardPage"),
  () => import("@/pages/finance/FinanceReviewPage"),
  () => import("@/pages/finance/FinancePaymentsPage"),
  () => import("@/pages/finance/FinanceBudgetPage"),
  () => import("@/pages/finance/FinanceCashCountPage"),
  () => import("@/pages/finance/FinanceSummaryPage"),
  () => import("@/pages/finance/FinanceTransfersPage"),
